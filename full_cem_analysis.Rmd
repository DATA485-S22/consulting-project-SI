...
data <- read.csv("data/CEM_full_dataset.csv")
#data <- read.csv("C:/Box/Projects_Current/SI Equity analysis/data/CEM_dataset.csv")

data <- data %>% filter(Term != "Spring 2019") %>% filter(Term.Year < 2020)
